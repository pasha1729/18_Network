...
// ** METHOD **
	...
	private void initWordList ()
	{
		...
		wordList.add ("네트워크"); wordList.add ("마을회관"); wordList.add ("학생회관"); wordList.add ("번뇌"); wordList.add ("새롬관");
		wordList.add ("소주"); wordList.add ("개강"); wordList.add ("CC"); wordList.add ("종강"); wordList.add ("MT");
		wordList.add ("탄소"); wordList.add ("수소"); wordList.add ("산소"); wordList.add ("질소"); wordList.add ("이산화탄소");
		wordList.add ("미적분학"); wordList.add ("화학"); wordList.add ("대동여지도"); wordList.add ("생명과학"); wordList.add ("물리");
		wordList.add ("장학금"); wordList.add ("장군"); wordList.add ("소프트웨어산업세미나"); wordList.add ("대나무"); wordList.add ("열매");
		wordList.add ("출석"); wordList.add ("결석"); wordList.add ("지각"); wordList.add ("중간고사"); wordList.add ("기말고사");
		wordList.add ("기숙사"); wordList.add ("동아리"); wordList.add ("체육관"); wordList.add ("RC"); wordList.add ("남한산성");
		wordList.add ("버거킹"); wordList.add ("학생식당"); wordList.add ("포항공대"); wordList.add ("롤스로이스"); wordList.add ("카이스트");
		wordList.add ("모네"); wordList.add ("트로이카"); wordList.add ("플랑크"); wordList.add ("뉴턴"); wordList.add ("역설");
		wordList.add ("튜링"); wordList.add ("페이스북"); wordList.add ("카카오톡"); wordList.add ("구글"); wordList.add ("알파고");
		wordList.add ("고구려"); wordList.add ("강강술래"); wordList.add ("서울대공원"); wordList.add ("학생주임"); wordList.add ("대자보");
		wordList.add ("뒤풀이"); wordList.add ("가천관"); wordList.add ("트위터"); wordList.add ("매점"); wordList.add ("전야제");
		...
		wordList.add ("수강신청"); wordList.add ("파티"); wordList.add ("무형문화재"); wordList.add ("치킨"); wordList.add ("레포트");
		wordList.add ("질문"); wordList.add ("컵라면"); wordList.add ("다이어트"); wordList.add ("유재석"); wordList.add ("오픈북");
		wordList.add ("쿠폰"); wordList.add ("스마트폰"); wordList.add ("마지막잎새"); wordList.add ("전자출결"); wordList.add ("대리출석");
		wordList.add ("군계일학"); wordList.add ("데스크탑"); wordList.add ("소화기"); wordList.add ("자동제세동기"); wordList.add ("헬조선");
		wordList.add ("학생회장"); wordList.add ("계절학기"); wordList.add ("여름방학"); wordList.add ("겨울방학"); wordList.add ("대체공휴일");
		wordList.add ("통나무집"); wordList.add ("보드마카"); wordList.add ("콜로세움"); wordList.add ("인문학"); wordList.add ("물통");
		wordList.add ("메로나"); wordList.add ("조교"); wordList.add ("보조배터리"); wordList.add ("초코에몽"); wordList.add ("주윤발");
		wordList.add ("나쁜녀석들"); wordList.add ("롯데마트"); wordList.add ("홈플러스"); wordList.add ("시외버스터미널"); wordList.add ("고속버스터미널");
		wordList.add ("베스킨라빈스"); wordList.add ("물회"); wordList.add ("해운대"); wordList.add ("폭설"); wordList.add ("연지");
		...
		wordList.add ("쌍권총"); wordList.add ("복정동"); wordList.add ("대청소"); wordList.add ("마굿간"); wordList.add ("사이버캠퍼스");
		wordList.add ("모란시장"); wordList.add ("블루투스"); wordList.add ("와이파이"); wordList.add ("에어컨"); wordList.add ("뮤지컬");
		...
		wordList.add ("크리스마스"); wordList.add ("동아리연합회"); wordList.add ("대항해시대"); wordList.add ("코끼리"); wordList.add ("고담");
		wordList.add ("한화"); wordList.add ("인스턴트커피"); wordList.add ("참뼈"); wordList.add ("코인노래방"); wordList.add ("애덤스미스");
		wordList.add ("전기장판"); wordList.add ("버너"); wordList.add ("블라인드"); wordList.add ("커튼"); wordList.add ("고무동력기");
		wordList.add ("터미네이터"); wordList.add ("송중기"); wordList.add ("미생"); wordList.add ("냉장고를부탁해"); wordList.add ("창렬");
		wordList.add ("공학수학"); wordList.add ("양꼬치엔칭따오"); wordList.add ("옵티머스프라임"); wordList.add ("아이언맨"); wordList.add ("조커");
		wordList.add ("캡틴아메리카"); wordList.add ("송아지"); wordList.add ("비밀의숲"); wordList.add ("고기뷔페"); wordList.add ("보라카이");
		wordList.add ("라바"); wordList.add ("미니언"); wordList.add ("캐러비안의해적"); wordList.add ("말할수없는비밀"); wordList.add ("쏘우");
		wordList.add ("절규"); wordList.add ("소나무"); wordList.add ("장갑차"); wordList.add ("스타벅스"); wordList.add ("가천대학교");
	}
